...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">患者管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>患者管理</span></li>
				<li class="breadcrumb-item-two"><span>患者列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('患者比例统计')"><i class="fa fa-database"></i><span>患者比例统计</span></button>
			</div>
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"huanzhe");
		...
		window.location.href = url;
                ...
                function chartDialog1(){
                    ...
                    $.ajax({
                        type: "GET",
                        url: baseUrl+"huanzhe/group/xingbie",
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('xingbieMain1'),'vintage');
                                    var option = {};
                                    option = {
                                            title: {
                                                text: '患者比例统计',
