...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑药品信息</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑药品信息</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>批次号</label>
					<input name="picihao" id="picihao" name="picihao" class="form-control" placeholder="请输入批次号">
				</div>
				<div class="form-item">
					<label>生产日期</label>
				...
				<div class="form-item">
					<label>使用说明</label>
					<textarea  name="shiyongshuoming" class="form-control textarea" id="shiyongshuoming" rows="3"></textarea>
				</div>
			...
			http("option/yaopinleixing/yaopinleixing","GET",{},(res)=>{
				if(res.code == 0){
					...
					for(var i=0;i<yaopinleixingOptions.length;i++){
						...
						if(ruleForm.yaopinleixing == yaopinleixingOptions[i]){
							yaopinleixingOption.setAttribute('selected','selected');
						}
