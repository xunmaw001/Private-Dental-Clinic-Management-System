...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">患者病历管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>患者病历列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>病历编号</label>
					<input type="text" id="binglibianhaoSearch" class="form-control form-control-sm" placeholder="请输入病历编号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>账号</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('binglibianhao')">病历编号<i id="binglibianhaoIcon" class="fa fa-sort"></i></th>
						...
						<th onclick="sort('guominshi')">过敏史<i id="guominshiIcon" class="fa fa-sort"></i></th>
						<th>诊断情况</th>
						<th>药单信息</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var guominshiCell  = document.createElement('td');

						 guominshiCell.innerHTML = item.guominshi;

			row.appendChild(guominshiCell);
			var zhenduanqingkuangCell  = document.createElement('td');

						  if(item.zhenduanqingkuang != null && item.zhenduanqingkuang != "" && item.zhenduanqingkuang.length >= 11){
			  	zhenduanqingkuangCell.innerHTML = item.zhenduanqingkuang.substring(0, 10) + "..."; 
			  }else{
			  	zhenduanqingkuangCell.innerHTML = item.zhenduanqingkuang;
			  }


			row.appendChild(zhenduanqingkuangCell);
			var yaodanxinxiCell  = document.createElement('td');

						  if(item.yaodanxinxi != null && item.yaodanxinxi != "" && item.yaodanxinxi.length >= 11){
			  	yaodanxinxiCell.innerHTML = item.yaodanxinxi.substring(0, 10) + "..."; 
			  }else{
			  	yaodanxinxiCell.innerHTML = item.yaodanxinxi;
			  }


			row.appendChild(yaodanxinxiCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("huanzhebingli/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("huanzhebingli"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"huanzhebingli");
