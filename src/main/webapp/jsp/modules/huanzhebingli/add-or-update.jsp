	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>住址</label>
					<input name="zhuzhi" id="zhuzhi" name="zhuzhi" class="form-control" placeholder="请输入住址">
				</div>
				<div class="form-item">
					<label>过敏史</label>
					<input name="guominshi" id="guominshi" name="guominshi" class="form-control" placeholder="请输入过敏史">
				</div>
				<div class="form-item">
					<label>诊断情况</label>
					<textarea  name="zhenduanqingkuang" class="form-control textarea" id="zhenduanqingkuang" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>药单信息</label>
					<textarea  name="yaodanxinxi" class="form-control textarea" id="yaodanxinxi" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>账号</label>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("huanzhebingli/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("huanzhebingli/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("huanzhebingli/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#guominshi").val(ruleForm.guominshi);	
			$("#zhenduanqingkuang").val(ruleForm.zhenduanqingkuang);
			$("#yaodanxinxi").val(ruleForm.yaodanxinxi);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.guominshi != null && res.data.guominshi != ''){

						$("#guominshi").val(res.data.guominshi);
						$("#guominshi").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.zhenduanqingkuang != null && res.data.zhenduanqingkuang != ''){

						$("#zhenduanqingkuang").val(res.data.zhenduanqingkuang);
					}
					if(res.data != null && res.data != '' && res.data.yaodanxinxi != null && res.data.yaodanxinxi != ''){

						$("#yaodanxinxi").val(res.data.yaodanxinxi);
					}
