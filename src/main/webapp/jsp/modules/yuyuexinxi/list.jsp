...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">预约信息管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>预约信息管理</span></li>
				<li class="breadcrumb-item-two"><span>预约信息列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('预约人数统计')"><i class="fa fa-database"></i><span>预约人数统计</span></button>
			</div>
            ...
            <div class="openBox" v-if="showType1">
                ...
                <div class="openView">
                    <div id="yuyueshijianMain1" class="graph" style="width: 70vw;height:50vh;"></div>
                </div>
            </div>
		</div>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "添加病历"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'huanzhebingli','是','[1]','已添加病历！')");
			if(crossBtnControl('添加病历') == true){
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"yuyuexinxi");
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('yuyueshijianMain1'),'royal');
                                    var option = {};
                                    option = {
                                        title: {
                                            text: '预约人数统计',
