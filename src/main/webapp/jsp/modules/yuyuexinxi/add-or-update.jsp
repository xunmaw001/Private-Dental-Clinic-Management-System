...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑预约信息</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑预约信息</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>预约内容</label>
					<input name="yuyueneirong" id="yuyueneirong" name="yuyueneirong" class="form-control" placeholder="请输入预约内容">
				</div>
				<div class="form-item">
					<label>预约时间</label>
					<input id="yuyueshijian-input" class="date" name="yuyueshijian" size="15" type="text" readonly placeholder="请选择预约时间">
				</div>
				<div class="form-item">
					<label>用户名</label>
	...
	<script>
		...
		function submit() {
               //获取表单数据前取消禁用
                $("#yuyueshijian-input").attr('disabled',false);
		...
		function dateTimePick(){
			...
			$("#yuyueshijian-input").val(getCurDate());
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#yuyueshijian-input").attr('disabled',true);
            }
		}
