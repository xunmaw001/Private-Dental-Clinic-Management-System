...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">药品购买管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>药品购买列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="btns">
				...
				<button onclick="chartDialog1()" type="button" class="btn btn-info btn-statis" v-if="crossBtnControl('药品销量统计')"><i class="fa fa-database"></i><span>药品销量统计</span></button>
			</div>
	...
	<script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yaopingoumai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"yaopingoumai");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"yaopingoumai");
                        ...
                        success: function(data){
                            if(data.code == 0){
                                if(data.data != null){
                                    ...
                                    var myChart = echarts.init(document.getElementById('shuliangMain1'),'vintage');
                                    var option = {};
                                    option = {
                                        title: {
                                            text: '药品销量统计',
