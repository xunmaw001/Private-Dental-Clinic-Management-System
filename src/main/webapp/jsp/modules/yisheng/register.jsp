...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  name="yishengxingming"  placeholder="请输入医生姓名" class="form-control-i">
				</div>
                <div class="list-item">
				...
				<div class="list-item">
					<input  name="yiling"  placeholder="请输入医龄" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="zhicheng"  placeholder="请输入职称" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="keshi"  placeholder="请输入科室" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="guahaofei"  placeholder="请输入挂号费" class="form-control-i">
				</div>
				<div class="list-item">
					<input  name="dianhua"  placeholder="请输入电话" class="form-control-i">
				</div>
