...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">医生管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>医生列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>医龄</label>
					<input type="text" id="yilingSearch" class="form-control form-control-sm" placeholder="请输入医龄" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>科室</label>
					<input type="text" id="keshiSearch" class="form-control form-control-sm" placeholder="请输入科室" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			...
			if($('#yilingSearch').val() != null && $('#yilingSearch').val() != ''){
				searchForm.yiling ="%" +  $('#yilingSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var yishengjianjieCell  = document.createElement('td');

						  if(item.yishengjianjie != null && item.yishengjianjie != "" && item.yishengjianjie.length >= 11){
			  	yishengjianjieCell.innerHTML = item.yishengjianjie.substring(0, 10) + "..."; 
			  }else{
			  	yishengjianjieCell.innerHTML = item.yishengjianjie;
			  }


			row.appendChild(yishengjianjieCell);
	...
	function discussList(id) {
            ...
            window.location.href = "../discussyisheng/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
