				...
				<div :style='{"boxShadow":"0 0px 0px 0 rgba(0, 0, 0, .1)","padding":"15px","borderColor":"#fff","borderWidth":"0px","background":"none","width":"100%","borderStyle":"groove"}' class="message-list" v-if="dataList.length">
					<div :style='{"padding":"10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"0 0 20px","borderColor":"#eee","alignItems":"center","borderWidth":"0px","width":"100%","borderStyle":"solid","height":"auto"}' class="message-item" v-for="(item,index) in dataList" v-bind:key="index" >
						<div :style='{"padding":"6px 0","borderColor":"#eee","alignItems":"center","borderWidth":"0 0 0px","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(240,240,240,1) 95%, rgba(189,189,189,1) 100%)","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"center","height":"auto"}' class="username-container">
							<img v-if="item.avatarurl" :style='{"width":"40px","margin":"0 10px 0 10px","borderRadius":"100%","objectFit":"cover","height":"40px","order":"2"}' class="avator" :src="baseurl + item.avatarurl">
							<img v-else :style='{"width":"40px","margin":"0 10px 0 10px","borderRadius":"100%","objectFit":"cover","height":"40px","order":"2"}' class="avator" src="../../img/avator.png">
							<div :style='{"color":"#992298","fontSize":"16px"}' class="username">{{item.username}}</div>
						</div>
						...
						<div :style='{"padding":"8px","margin":"10px 0px 0px","borderColor":"#c7eec2","color":"#20ad9e","borderRadius":"0px","background":"none","borderWidth":"0px","lineHeight":"24px","fontSize":"14px","borderStyle":"solid","textIndent":"2em"}' v-if="item.reply" class="replay">
							回复：{{item.reply}}
						</div>
