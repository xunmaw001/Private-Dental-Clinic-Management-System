				...
				<div :style='{"width":"100%","padding":"0","margin":"0","background":"url() repeat-x center top","flex":"1"}' class="right-container">
					<form :style='{"padding":"20px 0 0","boxShadow":"0px 0px 0px #eee","borderColor":"#ddd","flexWrap":"wrap","background":"none","borderWidth":"0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}' class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">用户名</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text" readonly="readonly" name="yonghuming" name="yonghuming" id="yonghuming" placeholder="用户名" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">姓名</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text"  name="xingming" name="xingming" id="xingming" placeholder="姓名" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"padding":"0 15px","color":"#992298","textAlign":"right","width":"auto","lineHeight":"40px","fontSize":"15px","minWidth":"90px","fontWeight":"500"}' class="layui-form-label">年龄</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#555","outline":"none","borderRadius":"0px","borderWidth":"0px","background":"#fff","width":"100%","fontSize":"14px","lineHeight":"32px","borderStyle":"solid","height":"32px"}' type="text"  name="nianling" name="nianling" id="nianling" placeholder="年龄" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"2px 10px","margin":"0 0 20px 0","borderColor":"#efe4d4","alignItems":"center","background":"linear-gradient(90deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","display":"flex","width":"48%","borderStyle":"solid"}'>
