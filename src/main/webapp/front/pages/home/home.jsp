	...
	<body>
			...
			<div :style='{"width":"100%","margin":"0px auto","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
				...
				<div class="news" :style='{"padding":"0px","margin":"0px  7%","borderColor":"#98dd90","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","display":"flex","width":"56%","position":"relative","borderStyle":"dotted","order":"8"}'>
					...
					<div class="title" :style='{"padding":"0px 0 0px","margin":"30px auto 20px","borderRadius":"0px","alignItems":"center","background":"none","flexDirection":"row","display":"flex","width":"100%","position":"relative","justifyContent":"flex-start","height":"50px"}'>
						...
						<span :style='{"margin":"0 10px 0 0","color":"#202020","textAlign":"center","background":"none","display":"inline-block","width":"auto","fontSize":"32px","lineHeight":"60px","fontWeight":"bold","height":"60px"}'>公告信息</span>
					</div>
			...
			<!-- 新闻资讯 -->
				...
				<div class="lists" :style='{"padding":"40px 7% 100px","margin":"0px auto 0","borderColor":"#98c6e2","flexWrap":"wrap","textAlign":"center","background":"#f4f4f4","borderWidth":"0 0 0px","display":"block","width":"100%","position":"relative","borderStyle":"dotted","order":"4"}'>
					...
					<div class="title" :style='{"padding":"0px 7% 20px","margin":"20px auto 40px","borderRadius":"0px","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230130/2d385bca38bb476596d3946973a96593.png) no-repeat center bottom","flexDirection":"row","display":"flex","width":"auto","position":"relative","justifyContent":"center"}'>
					  ...
					  <span :style='{"padding":"0","margin":"0 10px 0 0","color":"#202020","background":"none","display":"inline-block","fontSize":"32px","fontWeight":"bold","height":"56px"}'>病例信息展示</span>
					</div>
				    ...
				    <div class="list list-3">
						<div :style='{"width":"100%","padding":"100px 40px","borderRadius":"16px","background":"linear-gradient(90deg, rgba(151,36,152,1) 0%, rgba(32,173,158,1) 100%)","height":"auto"}' class="swiper-container" id="listsbinglixinxi">
							<div class="swiper-wrapper">
								<div class="swiper-slide animation-box" :style='{"cursor":"pointer","border":"0px solid #eee","padding":"0px","borderRadius":"4px","background":"none","fontSize":"0","position":"relative"}' v-for="(item,index) in binglixinxiList" :key="index" @click="jump('../binglixinxi/detail.jsp?id='+item.id)">
									<img :name="item.id" :style='{"border":"0px dotted #fff","width":"calc(100% - 20px)","padding":"20px","margin":"0 0 10px","background":"url(http://codegen.caihongy.cn/20230130/d254b3d5ad3f44648d9c986526c6f303.png) no-repeat center top / 100% 100%","height":"250px"}' :src="item.tupian?baseurl+item.tupian.split(',')[0]:''" alt="" />
									<div :style='{"padding":"0 10px","borderColor":"#b5e8af","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","width":"90%","fontSize":"14px","lineHeight":"40px","borderStyle":"solid"}' class="name">{{item.binglimingcheng}}</div>
									<div :style='{"padding":"0 10px","borderColor":"#b5e8af","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","width":"90%","fontSize":"14px","lineHeight":"40px","borderStyle":"solid"}' class="name">{{item.binglileixing}}</div>
								</div>
							</div>
														<!-- 如果需要导航按钮 -->
				...
				<div class="lists" :style='{"padding":"40px 7% 100px","margin":"0px auto 0","borderColor":"#98c6e2","flexWrap":"wrap","textAlign":"center","background":"#f4f4f4","borderWidth":"0 0 0px","display":"block","width":"100%","position":"relative","borderStyle":"dotted","order":"4"}'>
					...
					<div class="title" :style='{"padding":"0px 7% 20px","margin":"20px auto 40px","borderRadius":"0px","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230130/2d385bca38bb476596d3946973a96593.png) no-repeat center bottom","flexDirection":"row","display":"flex","width":"auto","position":"relative","justifyContent":"center"}'>
					  <span :style='{"fontSize":"24px","lineHeight":"50px","color":"#555","display":"inline-block","order":"2","textTransform":"uppercase"}'>DATA SHOW</span>
					  <span :style='{"padding":"0","margin":"0 10px 0 0","color":"#202020","background":"none","display":"inline-block","fontSize":"32px","fontWeight":"bold","height":"56px"}'>药品信息展示</span>
					</div>
					...
					<!-- 样式三 -->
				    <div class="list list-3">
						<div :style='{"width":"100%","padding":"100px 40px","borderRadius":"16px","background":"linear-gradient(90deg, rgba(151,36,152,1) 0%, rgba(32,173,158,1) 100%)","height":"auto"}' class="swiper-container" id="listsyaopinxinxi">
							<div class="swiper-wrapper">
								<div class="swiper-slide animation-box" :style='{"cursor":"pointer","border":"0px solid #eee","padding":"0px","borderRadius":"4px","background":"none","fontSize":"0","position":"relative"}' v-for="(item,index) in yaopinxinxiList" :key="index" @click="jump('../yaopinxinxi/detail.jsp?id='+item.id)">
									<img :name="item.id" :style='{"border":"0px dotted #fff","width":"calc(100% - 20px)","padding":"20px","margin":"0 0 10px","background":"url(http://codegen.caihongy.cn/20230130/d254b3d5ad3f44648d9c986526c6f303.png) no-repeat center top / 100% 100%","height":"250px"}' :src="item.tupian?baseurl+item.tupian.split(',')[0]:''" alt="" />
									<div :style='{"padding":"0 10px","borderColor":"#b5e8af","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","width":"90%","fontSize":"14px","lineHeight":"40px","borderStyle":"solid"}' class="name">{{item.yaopinmingcheng}}</div>
									<div :style='{"padding":"0 10px","borderColor":"#b5e8af","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","width":"90%","fontSize":"14px","lineHeight":"40px","borderStyle":"solid"}' class="name">{{item.yaopinleixing}}</div>
									<div :style='{"padding":"0 10px","borderColor":"#b5e8af","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","width":"90%","fontSize":"14px","lineHeight":"40px","borderStyle":"solid"}' class="name">价格:{{item.jiage}}</div>
									<div :style='{"padding":"0 10px","borderColor":"#b5e8af","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","borderWidth":"0 0 0px","width":"90%","fontSize":"14px","lineHeight":"40px","borderStyle":"solid"}' class="name">{{item.shengchanriqi}}</div>
								</div>
							</div>
														<!-- 如果需要导航按钮 -->
							<div class="swiper-button-prev"></div>
					...
					<div :style='{"border":"0","cursor":"pointer","padding":"0 20px","margin":"0 0 0 -100px","borderColor":"#999","textAlign":"center","bottom":"80px","display":"inline-block","minWidth":"200px","borderRadius":"30px","background":"url(http://codegen.caihongy.cn/20230130/900bb2bf212e4ef8a599ed8502aa2b9d.png) no-repeat 90% center,#20ad9e","borderWidth":"0px","width":"auto","lineHeight":"44px","position":"absolute","borderStyle":"solid","zIndex":"99"}' @click="jump('../yaopinxinxi/list.jsp')">
						<span :style='{"color":"#fff","fontSize":"14px"}'>查看更多</span>
						<i v-if='true' :style='{"color":"#555","fontSize":"14px","display":"none"}' class="layui-icon layui-icon-next"></i>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
                ...
                http.request(`binglixinxi/list`, 'get', {
					sort : 'fabushijian',
					order: 'desc',
					page: 1,
					limit: 8,
				}, function(res) {
					vue.binglixinxiList = res.data.list
					...
					if(flag == 3) {
						...
						vue.$nextTick(() => {
							new Swiper ('#listsbinglixinxi', options)
					...
					if(flag == 5) {
						vue.$nextTick(() => {
							var swiper = new Swiper('#lists-five-swiperbinglixinxi', {
								loop: true,
								speed: 600,
