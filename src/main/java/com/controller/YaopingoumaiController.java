...
public class YaopingoumaiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YaopingoumaiEntity yaopingoumai, 
		...
		if(tableName.equals("huanzhe")) {
			yaopingoumai.setYonghuming((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yaopingoumaiService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yaopingoumaiService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = yaopingoumaiService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,YaopingoumaiEntity yaopingoumai, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("huanzhe")) {
            yaopingoumai.setYonghuming((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<YaopingoumaiEntity> ew = new EntityWrapper<YaopingoumaiEntity>();
        int count = yaopingoumaiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yaopingoumai), params), params));
