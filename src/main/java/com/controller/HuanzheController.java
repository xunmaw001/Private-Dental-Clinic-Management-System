...
public class HuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HuanzheEntity u = huanzheService.selectOne(new EntityWrapper<HuanzheEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody HuanzheEntity huanzhe){
    	...
    	HuanzheEntity u = huanzheService.selectOne(new EntityWrapper<HuanzheEntity>().eq("yonghuming", huanzhe.getYonghuming()));
		if(u!=null) {
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        EntityWrapper<HuanzheEntity> ew = new EntityWrapper<HuanzheEntity>();
        List<Map<String, Object>> result = huanzheService.selectValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        EntityWrapper<HuanzheEntity> ew = new EntityWrapper<HuanzheEntity>();
        List<Map<String, Object>> result = huanzheService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        EntityWrapper<HuanzheEntity> ew = new EntityWrapper<HuanzheEntity>();
        List<Map<String, Object>> result = huanzheService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
